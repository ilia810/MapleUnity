...
namespace MapleClient.SceneGeneration
{
    ...
    public class TileGenerator
    {
        ...
        private void CreateTile(TileData tileData, Transform parent)
        {
            ...
            MapRenderOrder.SetOrder(renderer, MapRenderOrder.ReadTileOrder(tileData.Layer,
                tileData.TileSet, tileData.Variant, tileData.No,
                path => nxManager.DataManager.GetNode("map", path)));
